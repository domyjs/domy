!(function (e, t) {
  ...
  const X = [],
    ...
    z = new Map();
  function Y() {
    for (q = !0; K < X.length; ++K) {
      s(X[K], e => t(e));
    }
    if (K < X.length) Y();
    else {
      z.clear(), (K = 0), (X.length = 0), (q = !1);
  ...
  function Z(e, n) {
    ...
    i > 100
      ...
      : (z.set(n, i + 1), X.push(e), q || J.then(Y));
  }
  function ee() {
    return ++V;
  }
  ...
  const ne = { ..._, getHelpers: F, queuedWatchEffect: te };
  let oe = 0;
  class ie {
  ...
  function re(e) {
    ...
    e.effect(() => {
      ...
      if (o) {
        const e = G(s, t.style.cssText);
        (r = () => t.setAttribute('style', e.cleanedStyle(t.style.cssText))),
          t.setAttribute('style', e.style);
      } else if (i) {
        const e = j(s, t.className);
        (r = () => (t.className = e.cleanedClass(t.className))), (t.className = e.class);
      } else t.setAttribute(n, s);
    }),
      e.cleanup(() => {
        r ? r() : t.removeAttribute(n);
      });
  }
  function se(e, t) {
    return n => t(e, n);
      ...
      const r = (function (e) {
        ...
        return (
          a.includes('away') &&
            ((i = document.body),
            (o = se(o, (e, t) => {
              t.target === r || r.contains(t.target) || e(t);
            }))),
  ...
  function le(e) {
    ...
    if (e.utils.isBindAttr(e.attr.name)) return re(e);
      ...
      return function u(d) {
        ...
        for (; y.length > 0; ) {
          ...
          if (E.nodeType === Node.TEXT_NODE) {
            /\{\{\s*(?<org>.+?)\s*\}\}/g.test(
              null !== (m = E.textContent) && void 0 !== m ? m : ''
            ) && (ce(A.getPluginHelper()), S.addCleanup(A.getCleanupFn()));
            continue;
          }
          const L = E.localName in s,
            T = Array.from(null !== (v = E.attributes) && void 0 !== v ? v : []);
          for (const e of T) {
            ...
            (A = A.copy()), A.setAttrInfos(e), E.removeAttribute(e.name);
  ...
  function Te(e, t, n, o) {
    ...
    let r = n.nextSibling;
    for (; r && r !== o; )
      r.nodeType === Node.ELEMENT_NODE && r !== e && i.push(r), (r = r.nextSibling);
    const s = i[t] || o;
    e.nextSibling !== s && s.before(e);
  }
  function xe(e) {
    let t = 0;
    const n = e.block.el,
      ...
      e.effect(() => {
        ...
        for (let i = 0; i < p.length; ++i) {
          ...
          h.push({ element: b, index: i }),
            m.push(() => {
              const n = {
                render: e.deepRender({ element: b, scopedNodeData: [...e.scopedNodeData, s] }),
                reactiveIndex: f,
                loopId: t
              };
        ...
        for (let e = c.length - 1; e >= 0; --e) {
          const n = c[e];
          n.loopId !== t && (n.currentKey && u.delete(n.currentKey), c.splice(e, 1), s(n));
        }
        if (v) {
          const e = document.createDocumentFragment();
          for (const { element: t } of h) e.appendChild(t);
          i.after(e);
        } else for (const { element: e, index: t } of h) Te(e, t, i, r);
        for (const e of m) e();
      }),
      e.cleanup(() => {
        i.remove(), r.remove();
        for (const e of c) s(e);
      }),
  ...
  function Ie(e) {
    const t = e.modifiers.includes('dynamic') ? e.evaluate(e.attr.value) : e.attr.value,
      n = () => {
        e.state.refs[t] = e.skipReactive(e.block.el);
      };
    (() => {
      if (e.state.refs[t]) throw new Error(`A ref with the name "${t}" already exist.`);
      n();
    })(),
      e.block.onElementChange(n),
      e.cleanup(() => {
  ...
  function et(t, n, o) {
    var i;
    ++Ze;
    const r = null !== (i = null == n ? void 0 : n.parentPluginHelper) && void 0 !== i ? i : Ye();
    let s = {},
      a = {};
    function l(e) {
      return (() => {
          ...
          () => {
            ...
            for (const e of i.attributes) {
              ...
              if (r.utils.isBindAttr(e.name)) {
                ...
                r.effect(() => {
                  var n, o;
                  if ((l && l(), (t = r.evaluate(e.value)), r.lockWatchers(), s)) {
                    const e = r.utils.handleClass(
                      t,
            ...
            for (let e = 0; e < g.length; ++e) {
              const t = g[e],
                n = r.deepRender({ element: t, scopedNodeData: r.scopedNodeData });
              a.push(n.unmount.bind(n)), r.lockWatchers();
              let o = r.skipReactive(n.el);
              (o = o.parentNode ? o : void 0),
                m.push(o),
                n.name && (p[n.name] = o),
                v(),
                n.onElementChange(t => {
                  const o = r.skipReactive(t);
            ...
            const y = ee(),
              k = t => {
                ...
                r.appState.isMounted ? r.queueJob(n, y) : n();
              };
            k(l),
              ...
              r.cleanup(() => {
                b && b(), tt(a), r.unReactive(u), r.unReactive(h), r.unReactive(p);
              });
          },
          e => {
            i.remove(), tt(a), r.utils.error(`Component "${t}":`, e);
          }
        );
      };
    }
