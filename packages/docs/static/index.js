!(function (e, t) {
  ...
  function G(e) {
    ...
    e.effect(() => {
      ...
      e.cleanup(() => {
        ...
        e && 'style' === n
          ? (t.style = B(t.style.all, r))
          : e && 'class' === n
            ? (t.className = j(t.className, r))
            : t.removeAttribute(n);
      });
  }
  function _(e) {
  ...
  const re = { ...V, getHelpers: q, queuedWatchEffect: ie };
  let se = 0;
  class ae {
    ...
    effect(e) {
      const n = () => {
        this.isUnmountCalled || re.callWithErrorHandling(e, e => t(e));
      };
      if (this.renderWithoutListeningToChange) n();
      else {
        const e = re.queuedWatchEffect(n, { dontQueueOnFirstExecution: !this.appState.isMounted });
      ...
      {},
      {
        get(t, n, o) {
          ...
          return 'symbol' == typeof n
            ? Reflect.get(t, n, o)
            : null === (i = e.state.refs[n]) || void 0 === i
              ? void 0
              : i.el;
        }
      }
              ...
              if (r.utils.isBindAttr(e.name)) {
                ...
                r.effect(() => {
                  ...
                  (t = r.evaluate(e.value)),
                    r.lockWatchers(),
                    (u.$attrs[i] = s
                      ? r.utils.handleClass(t, null !== (n = u.$attrs[i]) && void 0 !== n ? n : '')
                      : a
                        ? r.utils.handleStyle(
                            t,
                  ...
                  s &&
                    r.cleanup(() => {
                      u.$attrs[i] = r.utils.handleRemoveClass(u.$attrs.class, t);
                    }),
                  a &&
                    r.cleanup(() => {
                      u.$attrs[i] = r.utils.handleRemoveStyle(u.$attrs.style, t);
                    });
              } else
                u.$attrs[i] = s
